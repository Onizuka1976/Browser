	...
	public SampleBrowserAWT() {
		...
		bstart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ChromeWindow.loadUrl("google.com", new ChromeSettings().tabname("javacef", true).right_button(false, true));
				// Create a tab with cookies.
				ChromeWindow.loadUrl("http://www.ericgiguere.com/tools/http-header-viewer.html",
